...
# 对接上一步的最新文件名
input_file = "m6A_21bp_latent_features_32d.csv"
...
plt.title('UMAP Projection of 21bp VAE Latent Space', fontsize=16)
...
plt.savefig('m6A_21bp_vae_umap_hdbscan_clusters.png', dpi=300, bbox_inches='tight')
