...
# 图表装饰
plt.title(f"SHAP Attribution: Determinants of the Isolated Island (Cluster {target_cluster}, Explainer N={len(explain_indices)})", fontsize=16, fontweight='bold', pad=20)
plt.tight_layout()

# 保存高质量图片
output_path = f"m6A_21bp_Cluster{target_cluster}_Island_SHAP.png"
