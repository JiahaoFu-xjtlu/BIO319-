...
# 对接上一步的最新文件名
input_file = "m6A_101bp_latent_features_32d.csv"
...
# 保存为 CSV
output_csv = "m6A_101bp_umap_hdbscan_labels.csv"
...
plt.title('UMAP Projection of 101bp VAE Latent Space', fontsize=16)
...
plt.savefig('m6A_101bp_vae_umap_hdbscan_clusters.png', dpi=300, bbox_inches='tight')
